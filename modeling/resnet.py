...
def ResNet18(output_stride, BatchNorm, pretrained=True):
    ...
    model = ResNet(BasicBlock, [2, 2, 2, 2], output_stride, BatchNorm, pretrained=pretrained, url=url)
    return model
...
def ResNet34(output_stride, BatchNorm, pretrained=True):
    ...
    model = ResNet(BasicBlock, [3, 4, 6, 3], output_stride, BatchNorm, pretrained=pretrained, url=url)
    return model
...
def ResNet50(output_stride, BatchNorm, pretrained=True):
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], output_stride, BatchNorm, pretrained=pretrained, url=url)
    return model
...
def ResNet101(output_stride, BatchNorm, pretrained=True):
    ...
    model = ResNet(Bottleneck, [3, 4, 23, 3], output_stride, BatchNorm, pretrained=pretrained, url=url)
    return model
